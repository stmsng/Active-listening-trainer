...
export type RecursivePartialNull<T> = MovedRecursivePartialNull<T>
    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        async DeriveVoice(
        character_message: string,character_characteristics: types.CharacterCharacteristics,character_state: types.CharacterState,
        __baml_options__?: BamlCallOptions<never>
          ...
          const __stream__ = this.stream.DeriveVoice(
          character_message,character_characteristics,character_state,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            "DeriveVoice",
            {
            "character_message": character_message,"character_characteristics": character_characteristics,"character_state": character_state
            },
            ...
            return __raw__.parsed(false) as types.VoiceDirections
            } catch (error) {
            throw toBamlError(error);
            }
            }
            
        async FilterPerception(
        raw_prosody: types.ProsodyScores,character_characteristics: types.CharacterCharacteristics,character_state: types.CharacterState,
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (__options__.onTick) {
          const __stream__ = this.stream.FilterPerception(
          raw_prosody,character_characteristics,character_state,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            "FilterPerception",
            {
            "raw_prosody": raw_prosody,"character_characteristics": character_characteristics,"character_state": character_state
            },
            this.ctxManager.cloneContext(),
            __options__.tb?.__tb(),
            __clientRegistry__,
            ...
            return __raw__.parsed(false) as types.PerceivedProsody
            } catch (error) {
            throw toBamlError(error);
            }
            }
            
        async GradeActiveListening(
        scenario: string,history: types.HistoryItem[],
        __baml_options__?: BamlCallOptions<never>
        ): Promise<types.Grade> {
          try {
          const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
          ...
          // Check if onTick is provided - route through streaming if so
          if (__options__.onTick) {
          const __stream__ = this.stream.GradeActiveListening(
          scenario,history,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.Grade
            } catch (error) {
            throw toBamlError(error);
            }
            }
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.Update
            } catch (error) {
            throw toBamlError(error);
            }
            }
            ...
            character_message: string,character_characteristics: types.CharacterCharacteristics,character_state: types.CharacterState,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.VoiceDirections, types.VoiceDirections>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for DeriveVoice", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.VoiceDirections, types.VoiceDirections>(
                  __raw__,
                  (a): partial_types.VoiceDirections => a,
                  (a): types.VoiceDirections => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
            ...
            raw_prosody: types.ProsodyScores,character_characteristics: types.CharacterCharacteristics,character_state: types.CharacterState,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.PerceivedProsody, types.PerceivedProsody>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for FilterPerception", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.PerceivedProsody, types.PerceivedProsody>(
                  __raw__,
                  (a): partial_types.PerceivedProsody => a,
                  (a): types.PerceivedProsody => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
            ...
            scenario: string,history: types.HistoryItem[],
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.Grade, types.Grade>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for GradeActiveListening", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.Grade, types.Grade>(
                  __raw__,
                  (a): partial_types.Grade => a,
                  (a): types.Grade => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
            ...
            __baml_options__?: BamlCallOptions<never>
              ...
              console.error("Error in onTick callback for Talk", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.Update, types.Update>(
                  __raw__,
                  (a): partial_types.Update => a,
                  (a): types.Update => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
